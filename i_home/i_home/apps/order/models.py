...
from i_home.utils.models import BaseModel
...
class Order(BaseModel):
    ...
    user = models.ForeignKey("users.User", on_delete=models.CASCADE, verbose_name='用户订单')
    house = models.ForeignKey("house.House", on_delete=models.SET_NULL, verbose_name='房屋订单', null=True)
